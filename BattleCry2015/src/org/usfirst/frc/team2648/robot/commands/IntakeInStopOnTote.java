 ...
 *
 */
public class IntakeInStopOnTote extends Command {
    ...
    public IntakeInStopOnTote(double rd, double ld, double eSpeed) {
    	//setTimeout(time);
